...
# Test cases
fibonacci_sequence(10) # Expected output: [0, 1, 1, 2, 3, 5, 8]
fibonacci_sequence(1)  # Expected output: [0, 1, 1]
fibonacci_sequence(0)  # Expected output: [0]
fibonacci_sequence(-5)  # Expected: Empty list or error message
